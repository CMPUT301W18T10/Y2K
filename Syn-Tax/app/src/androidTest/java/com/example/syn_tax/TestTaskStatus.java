...
public class TestTaskStatus extends ActivityInstrumentationTestCase2 {
    ...
    public void testStatus(){
        ...
        Task testTask = new Task("get status","new task",testUser,"requested", null, 0.0, 0.0);

        testTask.setStatus("bidded");
        assertEquals("bidded", testTask.getStatus());

        User testUser2 = new User("Oj","test@gmail.com", "999-999-999");
        Task testTask2 = new Task("get status","get status",testUser, "requested",  null, 0.0, 0.0);
        ...
        Task testTask3 = new Task("get status","get status",testUser,"requested",  null, 0.0, 0.0);

        testTask3.setStatus("done");
        assertEquals("done", testTask3.getStatus());

        User testUser4 = new User("Oj","test@gmail.com", "999-999-999");
        Task testTask4 = new Task("get status","get status",testUser,"requested",  null, 0.0, 0.0);
